...
// Ensure $users is an array before calling count
...
<body>
    <div class="container">
        ...
        <a href="../Views/create.php" class="btn">Create User</a>
        <!-- <a href="../app/Views/create.php" class="btn">Create User</a> -->
                ...
                <?php if (count($users) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="actions-column">
                            ...
                            <a href="../Controllers/UserController.php?action=delete&id=<?= $user['ID']; ?>" class="action-link" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                            <a href="../Views/edit.php?action=edit&id=<?php echo $user['ID']; ?>" class="action-link" onclick="return confirm('Are you sure you want to edit this user');">Edit</a>
